...
public class GeneticConfigs {
    ...
    public static final int COMPUTE_DURATION_MILLISECONDS = 100*1000;
    public static final int MAX_ITERATIONS_NO_UPDATE = 1000;
    public static final int ITERATIONS_LIMIT = 2000;
}

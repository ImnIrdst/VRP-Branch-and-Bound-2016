...
public class Genetic1AutoTest {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        String tableHeader = "TestID," + SCSTestCase.getTableHeader() + "Cost,Time,Iterations,ChromosomeQty";
...
//            geneticAlgorithm.printBestChromosome();
                ...
                String tableRow = String.format("%d,%d,%s,%s,%s,%s,%s", id, testId,
                        testCase.getCSVRow(), cost, time, iterations, iterationLimit);
...
//            System.out.println(testInfo);
                ...
                if ((id + 1) % testBatch == 0) {
                    String averageRow = String.format("avg,%d,%d,%d,%.2f,%.2f,%.0f,%.0f", testId,
